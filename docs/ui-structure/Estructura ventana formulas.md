...
└── root (QVBoxLayout, transparente, sin borde, márgenes 14 px, separación 10 px)
    ...
    └── splitter horizontal (objectName `recipesMainSplitter`, fondo transparente, sin borde, handle transparente de 5 px, childrenCollapsible=False, tamaños iniciales 332 / 930)
        ...
        │       ├── pestaña IREKS (inactiva: fondo #F7FAFD, texto apagado #6A7890 y borde #DDE5F0; activa: fondo #FFFFFF, texto #1D4ED8 y borde inferior azul #2563EB; esquinas rectas)
        ...
        │       └── pestaña Clientes (inactiva: fondo #F7FAFD, texto apagado #6A7890 y borde #DDE5F0; activa: fondo #FFFFFF, texto #1D4ED8 y borde inferior azul #2563EB; esquinas rectas)
