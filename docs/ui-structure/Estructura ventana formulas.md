...
└── root (QVBoxLayout, transparente, sin borde)
    └── splitter horizontal (objectName `recipesMainSplitter`, fondo transparente, sin borde, sin tirador visible, childrenCollapsible=False, tamaños iniciales 332 / 930)
        ...
        │   ├── QLabel "Recetas" (fondo transparente, sin borde)
        ...
        └── panel derecho (QWidget, objectName `recipesContentPanel`, fondo transparente, sin borde, ocupa el espacio restante)
            ├── barra de acciones (QHBoxLayout, transparente, sin borde)
            │   ├── Nueva (QPushButton, fondo #5BBE6A, borde #5BBE6A, radio 6 px)
            │   ├── Guardar (QPushButton, fondo #2563EB, borde #2563EB, radio 6 px)
            │   ├── Guardar como versión (QPushButton, fondo #F0B429, borde #E2A81E, radio 6 px)
            │   ├── Duplicar (QPushButton, fondo #F3F6FA, borde #D7DEE8, radio 6 px)
            │   ├── Eliminar (QPushButton, fondo #D96464, borde #D96464, radio 6 px)
            │   ├── Recalcular (QPushButton, fondo #2563EB, borde #2563EB, radio 6 px)
            │   ├── Imprimir (QPushButton, fondo #F3F6FA, borde #D7DEE8, radio 6 px)
            │   ├── Exportar PDF (QPushButton, fondo #F3F6FA, borde #D7DEE8, radio 6 px)
            │   └── Exportar Excel (QPushButton, fondo #F3F6FA, borde #D7DEE8, radio 6 px)
