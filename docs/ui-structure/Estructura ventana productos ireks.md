                ...
                └── splitter vertical derecho (QSplitter, objectName `ireksDetailSplitter`, fondo transparente, sin borde)
                    ...
                    └── tabs_host
                        └── detail_tabs (QTabWidget)
                            ...
                            │       │   ├── cabecera estándar `uiRole="detailHeader"` (alto fijo 38 px, fondo #06213D, icono blanco `product-tag.svg` 26 px, título blanco 16 px)
