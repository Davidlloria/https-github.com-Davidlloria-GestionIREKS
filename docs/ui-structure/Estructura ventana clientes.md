...
└── layout principal (QVBoxLayout, márgenes 14 / 11 / 14 / 14 px, separación 10 px)
    ...
    │   ├── Listados (gris azulado #E2E8F0, texto #334155, icono `assets/icons/list.svg`, ancho fijo 110 px, alto 30 px, icono 20 px)
    │   ├── Actualizar (violeta claro #F3E8FF, texto #6B21A8, icono `assets/icons/refresh-cw.svg`, ancho fijo 110 px, alto 30 px, icono 20 px)
    │   ├── customerQueriesButton (QPushButton, etiqueta "Consultas", icono `assets/icons/brain.svg`, ancho fijo 110 px, alto 30 px, icono 20 px)
    │   ├── espacio flexible
...
- `create_standard_ribbon_button()` fija ancho `110 px`, alto `30 px`, icono `20 x 20 px` y color por `btnRole`.
