...
class CustomerNewClientsImportPreviewService:
    def preview(self, source: str | Path) -> CustomerImportPreviewResult:
        ...
        with engine.begin() as conn:
            customers_by_id = {
                str(row[0] or ""): {
                    ...
                    "cliente_codigo_distribuidor": self._to_int(row[2]),
        ...
        seen_distributor_codes: dict[int, int] = {}
        items: list[CustomerImportPreviewItem] = []
        ...
        for row in rows:
            ...
            if distributor_code_raw and distributor_code is None:
                messages.append(
                    f"Codigo de cliente de distribuidor no numerico o ambiguo en columna C: {distributor_code_raw}."
                )
                ...
                rows.append(
                    {
                        ...
                        "cliente_codigo_distribuidor": self._to_int(values[2]),
