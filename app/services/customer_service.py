...
from app.services.sales_annual_comparison_service import SalesAnnualComparisonService, SalesClientsComparisonRow
...
class CustomerService:
    ...
    def related_sales(self, cliente_id: str, year: int) -> list[SalesClientsComparisonRow]:
        clean_id = str(cliente_id or "").strip()
