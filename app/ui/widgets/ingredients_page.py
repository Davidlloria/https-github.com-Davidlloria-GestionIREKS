...
class IngredientsIreksPage(QWidget):
    ...
    def _build_ui(self) -> None:
        ...
        entradas_card_layout.setContentsMargins(4, 4, 4, 4)
        entradas_card_layout.setSpacing(4)
        ...
        salidas_layout.setContentsMargins(4, 4, 4, 4)
        salidas_layout.setSpacing(4)
        ...
        stock_layout.setContentsMargins(4, 4, 4, 4)
        ...
        mensual_layout.setContentsMargins(4, 4, 4, 4)
        mensual_layout.setSpacing(4)
        ...
        pedidos_layout.setContentsMargins(4, 4, 4, 4)
        pedidos_layout.setSpacing(4)
        ...
        tarifa_layout.setContentsMargins(4, 4, 4, 4)
        tarifa_layout.setSpacing(4)
        ...
        nutricion_layout.setContentsMargins(4, 4, 4, 4)
        nutricion_layout.setSpacing(4)
        ...
        clientes_layout.setContentsMargins(4, 4, 4, 4)
    ...
    def _build_ireks_data_tab(self) -> QWidget:
        ...
        classification_layout.setContentsMargins(4, 4, 4, 12)
        ...
        presentation_layout.setContentsMargins(4, 4, 4, 12)
        ...
        pallet_layout.setContentsMargins(4, 4, 4, 12)
