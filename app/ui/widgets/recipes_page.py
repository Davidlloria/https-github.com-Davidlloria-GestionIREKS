...
class RecipesPage(QWidget):
    ...
    def _build_ui(self) -> None:
        ...
        self.recipe_pdf_btn = create_standard_ribbon_button("Pdf", role="secondary", icon_name="file-text.svg")
        self.recipe_excel_btn = create_standard_ribbon_button("Excel", role="secondary", icon_name="sheet.svg")
        ...
        receta_left_layout.addWidget(recipe_process_row)
        ...
        escandallo_layout.setSpacing(5)
        escandallo_ribbon, escandallo_ribbon_layout = create_standard_top_ribbon()
        escandallo_ribbon.setObjectName("escandalloRibbon")
