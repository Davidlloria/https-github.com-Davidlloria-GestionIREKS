...
class SalesPage(QWidget):
    ...
    def _build_ui(self) -> None:
        ...
        filters_top.addWidget(QLabel("Fabricante"))
        ...
        filters_top.addWidget(self.manufacturer_filter)

        filters_top.addWidget(QLabel("Familia"))
        ...
        filters_top.addWidget(self.family_filter)

        filters_top.addWidget(QLabel("Subfamilia"))
        ...
        filters_top.addWidget(self.subfamily_filter)
