...
class SalesPage(QWidget):
    ...
    def _build_ui(self) -> None:
        ...
        igsa_year_layout.addWidget(QLabel("Año"))
        ...
        igsa_month_layout.addWidget(QLabel("Mes"))
        ...
        igsa_acumulado_layout.addWidget(QLabel("Acumulado"))
        ...
        acumulado_layout.addWidget(QLabel("Acumulado"))
